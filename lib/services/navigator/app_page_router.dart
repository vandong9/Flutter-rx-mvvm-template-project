...
class AppPageRoute<T> extends PageRoute<T> {
  ...
  bool _defaultPopGesture = true;
  Transition _defaultTransition = Transition.native;
  ...
  Widget buildTransitions(BuildContext context, Animation<double> animation,
    ...
    switch (transition ?? _defaultTransition) {
      ...
      case Transition.noTransition:
        return popGesture ?? _defaultPopGesture
            ? _CupertinoBackGestureDetector<T>(
                enabledCallback: () => _isPopGestureEnabled<T>(this),
                onStartPopGesture: () => _startPopGesture<T>(this),
                child: child)
